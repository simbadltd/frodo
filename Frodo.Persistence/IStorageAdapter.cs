...
namespace Frodo.Persistence
{
    public interface IStorageAdapter
    {
        ...
        void Save<T>(T model, IDbConnection connection, IDbTransaction transaction) where T : Dao;
        void Save(Dao model, Type type, IDbConnection connection, IDbTransaction transaction);
